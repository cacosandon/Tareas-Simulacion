...
class Supermercado:
    def __init__(self, cajas):
        ...
        self.proximas_atenciones = [datetime(2018,8,11,1,0,0) for i in range (cajas)]
    ...
    def __str__(self):
        self.simular()
        min = int(self.espera_promedio())
        sec = (self.espera_promedio())%1*(60)
        return f"El tiempo de espera promedio fue de {min} minutos y {sec} segundos."
